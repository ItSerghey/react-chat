...
export const isFetching = (state = intialState.isFetching, action) => {
  switch (action.type) {
    ...
    case types.FETCH_CHATINFO_REQUEST:
      return { ...state, getChatInfoById: true };
    ...
    case types.FETCH_CHATINFO_SUCCESS:
    case types.FETCH_CHATINFO_FAILURE:
      return { ...state, getChatInfoById: false };
